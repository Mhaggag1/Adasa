...
@Component({
  selector: 'app-blogs',
  imports: [RouterLink, RouterLinkActive, RouterOutlet, Suggested],
...
export class Blogs {
  ...
  category: Icategory[] = [
    { name: 'إضاءة', count: 3, title: 'light' },
    { name: 'بورتريه', count: 3, title: 'portrait' },
    { name: 'مناظر طبيعية', count: 2, title: 'nature' },
    { name: 'تقنيات', count: 5, title: 'tech' },
    { name: 'معدات', count: 3, title: 'equip' },
  ];
  view: 'list' | 'grid' = 'grid';
  gridCLasses: string[] = ['grid', 'grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-3', 'gap-8'];
}
